...
// closure.
//
// §5.1 ("Reference semantics") of `openbindings.openapi-3.1@1` and its siblings states the rule: a reference
...
// an artifact the family's §5.1 says resolves, "however the
