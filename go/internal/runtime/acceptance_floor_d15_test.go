...
var floorD15Cases = []floorD15Case{
	...
	},
	{
		...
		// the defect remains on the response projection.
		name: "array-valued items in a response schema stays confined",
	...
	},
	{
		...
		// it remains on the response projection, like the string member below).
		//
