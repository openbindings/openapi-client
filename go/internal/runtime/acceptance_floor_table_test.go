...
// table, updated for the published smallest-owner response confinement and
// addressability algebra. The same table file, at the same digest, embeds in
// the standalone Go and TypeScript engines. OpenBindings integration moves to
// this answer after the standalone engine contract is frozen.
...
const (
	acceptanceFloorCaseTableSHA256 = "b7cd7bf071efe73d6675f9b2fee9bd1afe9be3658403397bf73e56ceb34277fa"
