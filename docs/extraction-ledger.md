...
| TypeScript artifact execution tests | cut over | 232 standalone tests plus the adapter's 579-test revision/conformance/corpus suite execute through this engine |
