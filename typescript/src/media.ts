...
// Reports whether an accepted OAS edition puts an
...
//
// @3 incorporates each accepted edition's own immutable text, so older
// artifacts keep their older default. The partition is pinned by the 64-cell
// twin table in urlencoded-lane-partition.test.ts, shared byte-for-byte with
// the two Go engines.
