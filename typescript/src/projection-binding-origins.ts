export const SERVER_DOCUMENT_MARKER = "x-openapi-client-internal-server-document";
export const OPERATION_DOCUMENT_MARKER = "x-openapi-client-internal-operation-document";
export const REFERRING_SECURITY_SCHEMES_MARKER = "x-openapi-client-internal-referring-security-schemes";
